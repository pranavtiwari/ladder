  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ textAlign: 'center', margin: '2rem 0' }}>
        ...
        <p style={{ color: 'var(--text-light)', fontSize: '1.2rem' }}>Understanding rankings, challenges, and ELO</p>
      </div>
      ...
      <div className="card">
        ...
        <div style={{ color: 'var(--text-dark)', lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ backgroundColor: 'rgba(34, 197, 94, 0.1)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid var(--primary-color)' }}>
          ...
          <div style={{ backgroundColor: 'rgba(148, 163, 184, 0.1)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid var(--text-light)' }}>
      ...
      <div className="card">
        <h2 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-dark)', marginBottom: '1rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.5rem' }}>
          <Swords size={20} color="#fb923c" />
          Challenge Rules
        </h2>
        <ul style={{ color: 'var(--text-dark)', lineHeight: 1.6, paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
      ...
      <div className="card">
        ...
        <p style={{ color: 'var(--text-dark)', lineHeight: 1.6, marginBottom: '1rem' }}>
